...
describe('extract ui schema', () => {
  ...
  it('should handle referenced schemas', () => {
    ...
    const uiSchema = extractUiSchema(refSchema);
    expect(uiSchema).toEqual(expected);
  });
  ...
  it('should handle schemas with multiple hierarchies', () => {
    ...
    const uiSchema = extractUiSchema(complexSchema);
    expect(uiSchema).toEqual(expected);
  });
  ...
  it('should handle if/then/else schema with ui:widget: "textarea"', () => {
    ...
    const uiSchema = extractUiSchema(schemaWithIfThenElse);
    console.log(JSON.stringify(schemaWithIfThenElse, null, 4));
    console.log('\n\n\n');
              ...
              allOf: [
                {
                  ...
                  title: 'Primary Color',
                  'ui:widget': 'color',
                  'ui:help': 'Choose your preferred primary color',
                },
                {
                  type: 'string',
                  title: 'Secondary Color',
                  'ui:widget': 'select',
                  'ui:emptyValue': 'Select a color',
                },
              ],
            },
          },
